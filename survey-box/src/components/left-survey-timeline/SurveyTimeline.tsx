...
import { deletePage, updateCurrPage } from "../../redux/pageActions"
  ...
  return (
    <div className="timeline-container">
      ...
      <div className="page-example">
        ...
        <div key={`timeline-page-${index}`} className="single-page-container">
          ...
          <div className="page-preview">
            ...
            <div className="page-type">{ pages[index].page_type}</div>
          </div>
        </div>
        ) 
      }
