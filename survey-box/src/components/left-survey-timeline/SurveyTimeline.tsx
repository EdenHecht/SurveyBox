...
import { deletePage, updateCurrPage, updatePageOrder } from "../../redux/pageActions"
...
function SurveyTimeline() {
  ...
  const onDragEnd = useCallback((result) => {
    ...
    const updatedPageIndex = pagesCopy.findIndex(page => page.id === currPageId);
    ...
    <DragDropContext onDragEnd={onDragEnd}>
      <div className="timeline-container">
        ...
        <Droppable droppableId="timeline">
          { provided => (      
          <div className="page-example" {...provided.droppableProps} ref={provided.innerRef}>
            {pages.length !== 0 && pages.map((page:any, index:number) => 
            <Draggable key={`timeline-page-${index}`} draggableId={`timeline-page-${index}`} index={index}>
              {provided => (
              <div className="single-page-container" ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
